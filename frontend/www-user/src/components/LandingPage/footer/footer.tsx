...
export default function Footer() {
    return (
        <footer className="relative bg-mainBlack pt-24 pb-16 text-white overflow-hidden mt-auto">
            ...
            <div className="container max-w-[1250px] mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
                ...
                <div className="flex flex-col items-center md:items-end">
                    <div className="flex flex-col md:flex-row gap-10 md:gap-[51px] text-center md:text-left mt-8 md:mt-0">
                        <a href="/collaborate" className="text-white text-[14px] md:text-[16px] hover:text-gray-300 transition-colors select-none" draggable={false}>Хамтран ажиллах</a>
